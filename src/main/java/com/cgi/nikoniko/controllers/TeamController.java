...
//			model.addAttribute("fullName", this.getFullName(this.getUsersFirstname(this.setUsersForTeamGet(id)), this.getUsersLastname(this.setUsersForTeamGet(id))));
		...
		@Autowired
		IUserHasTeamCrudRepository teamUserCrud;
...
//			userHasTeamList = (ArrayList<UserHasTeam>) teamUserCrud.findAll();
//
...
//		}
		...
		public ArrayList<User> setUsersForTeamGet(Long idValue) {
			...
			List<BigInteger> idsBig = teamUserCrud.findAssociatedUser(idValue);
